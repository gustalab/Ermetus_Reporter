...
Bakıcı_gideri <- "Var"
  ...
  gelir_tablosu <- 
    ...
    tibble::tribble(
      ...
      "1/01/2021-31/12/2021",  2825L,
      "1/01/2022-30/06/2022",  4250L,
      "1/07/2022-31/12/2022",  5819L,
      "1/01/2023-30/06/2023",  8506L,
      "1/07/2023-31/12/2023",  11402L
...
```{r echo=FALSE, include=FALSE}
  ...
  odeme_hesaplama_degeri_1 <- if (Kısmi_Odeme_Tutarı_1 == "none") {0} else {Kısmi_Odeme_Tutarı_1 * (1 + (faiz_oranı/100)*(odeme1_gecen_gun / 365)) }
  
  
  odeme_hesaplama_degeri_2 <- if (Kısmi_Odeme_Tutarı_1 == "none") {0} else {Kısmi_Odeme_Tutarı_2 * (1 + (faiz_oranı/100)*(odeme2_gecen_gun / 365)) }
...
```{r echo=FALSE, include=FALSE}
 ...
 # 6- BAKICI GİDERİ HESAPLAMASI ----
  ...
  Bakici_Gideri_Donemi_kazanc_hesaplama_tablosu <- Bakici_Gideri_Donemi_filtered %>% 
    ...
    mutate(Kusur_Oranı = Kusur_Oranı) %>% 
    select(Donem_Bas, Donem_Son, Kazanilan_Gun, Brut, Kusur_Oranı) %>% 
...
gecici_donem_tazminat <- sum(Tam_Maluliyet_Donemi_Tablosu$Donem_Tazminat)
