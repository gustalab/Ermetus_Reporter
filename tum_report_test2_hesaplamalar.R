...
dosya_bilgiler <- read_excel("../app_bilirkisi/data/dosya_bilgiler.xlsx", sheet = "Sayfa1")

PR_TRH_2010 <- read_excel("../app_bilirkisi/data/TRH2010_son.xlsx", sheet = "Sayfa1")

Asgari_Tablo <- read_excel("../app_bilirkisi/data/Asgari_Ucret_Tablosu_rvz.xlsx", sheet = "Program")


Teminat_Limit_Tablosu <- read_excel("../app_bilirkisi/data/Teminat_Limit_Tablosu_rvz.xlsx", sheet = "Teminat")
...
parametre_tablosu <- data.frame(PARAMETRE = c("Dosya_No", "Ad-Soyad", "Kaza Tarihi Yas","Hesap Tarihi Yas", "Cinsiyet", "Kaza Tarihi", 
                                              "Maluliyet Oranı", "Teknik Faiz", "Yaşam Tablosu", "Kusur Oranı", "Geçici İş Göremezlik Süresi (ay)", "Bakıcı Süresi (ay)",
...
parametre_tablosu2 <- tibble(
  ...
  "Bakıcı Süresi (ay)"= Bakıcı_gideri_suresi,
